...
public class Artikeltest {
	...
	public static void main(String[] args) {
		...
		/*
		 *  Erstellen Sie eine TreeMap, in der  Artikelobjekte aufgenommen werden können.
		 *  Als Key-Value soll die Artikelnummer verwendet werden.
		 */
		...
		/*
		 * Geben Sie die Values der TreeMap aus. 
		 */
		...
		/*
		 * Überführen Sie die Artikelobjekte (Values) der TreeMap in eine 
		...
		/*
		 * Überführen Sie die Artikelobjekte aus der Collection ll in 
		 * eine HashMap. Als Schlüssel soll hier wieder die Artikelnummer 
		 * dienen.
		 */
		...
		/*
		 * Geben Sie die Values der HashMap aus.
		 */
		...
		/*
		 * Übertragen Sie die Values der ll in eine andere Collection (ArrayList).
		 */
		...
		/*
		 * Geben Sie den Inhalt der ArrayList aus.
		 */
		...
		/*
		 *  Sortieren Sie die Objekte in der Liste nach dem Sortieralgorithmus, 
		 *  wie er in der Klasse Artikel definiert ist.
		 */
		...
		/*
		 * Erhöhen Sie für die Artikel in der TreeMap die Preise um 10%.
		 */
	 ...
	 * Übergeben Sie die Liste als Parameter. Sorgen Sie dafür, dass 
