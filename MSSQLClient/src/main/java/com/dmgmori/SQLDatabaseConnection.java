...
//		System.out.println(query);
	...
	public void insertInto(List<String> dataTypes, List<Object> data, String uid, SendMailTLS mail) {
				...
				for (int i = 0; i < columnList.length; i++) {
					...
					switch(dataTypes.get(i)) {
						...
						case "Date":   //preparedStmt.setTimestamp(i + 1, convertStringToTimestamp(data.get(i).toString()));
									   ...
									   System.out.println(convertToTimestamp((DateTime) data.get(i)));
									   break;
...
//				System.out.println("insertInto() erfolgreich ausgefuehrt.");
				...
				mail.appendMessageText("Document Id: " + uid + ". " +  e.getMessage() + " Could not write record to MSSQL DB.\n");
				mail.setErrorFlag(true);
			} finally {
