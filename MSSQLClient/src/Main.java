...
public class Main {
	...
	public void loadProperties() {
		...
		try {
			BufferedInputStream stream = new BufferedInputStream(new FileInputStream("src/config/" + MSSQL_PROPERTIES));
...
//			mssqlDatatypes = properties.getProperty("datatypes");
			...
			stream = new BufferedInputStream(new FileInputStream("src/config/" + NOTES_PROPERTIES));
			properties.load(stream);
